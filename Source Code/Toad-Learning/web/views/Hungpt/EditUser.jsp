                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Gender</label>
                                    <select value="${detail.gender}" name="gender" class="form-select" aria-label="Default select example">                              
                                ...
                                <div class="form-group">
                                    <label>Role</label>
                                    <select value="${detail.role}" name="role" class="form-select" aria-label="Default select example">                              
                                ...
                                <div class="form-group">
                                    <label>Gmail</label>
                                    <textarea name="gmail" class="form-control" required>${detail.gmail}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Mobile</label>
