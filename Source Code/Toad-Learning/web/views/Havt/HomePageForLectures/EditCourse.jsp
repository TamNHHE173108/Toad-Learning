                        ...
                        <div id="editNewCourse">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="editcourselectures" method="post">
                                        <div class="modal-header">						
                                            <h4 class="modal-title">Edit Course</h4>
                                            <button onclick="window.location.href = 'mycourse'" type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        </div>
                                        ...
                                        <div class="modal-footer">        
                                            <input onclick="window.location.href = 'mycourse'" type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
