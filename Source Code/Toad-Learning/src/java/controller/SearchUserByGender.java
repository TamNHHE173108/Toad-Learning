 ...
 */
@WebServlet(name="SearchUserByGender", urlPatterns={"/searchgender"})
public class SearchUserByGender extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        list = dao.searchUserByGender(gender); // Implement a method to fetch users by gender
    }
        request.setAttribute("listU", list);
        request.setAttribute("txtG", gender);
