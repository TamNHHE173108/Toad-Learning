 ...
 * @author Admin
 */
@WebServlet(name = "SortRegister", urlPatterns = {"/sortregister"})
public class SortRegister extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a != null) {
            ...
            if ("PriceASC".equals(sortPrice)) {
                listC = dao.sortByPriceASC(a.getUser_id());
            } else if ("PriceDESC".equals(sortPrice)) {
                listC = dao.sortByPriceDESC(a.getUser_id());
            } else {
                listC = dal.ListRegistration(a.getUser_id());
            }
            request.setAttribute("listR", listC);
            request.setAttribute("txtC", sortPrice);
